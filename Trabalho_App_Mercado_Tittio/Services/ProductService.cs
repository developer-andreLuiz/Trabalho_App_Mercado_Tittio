...
namespace Trabalho_App_Mercado_Tittio.Services
{
    public class ProductService
    {
        ...
        public async Task<ProductServiceModel> Get(int id)
        {
            ...
            {
                string content = await response.Content.ReadAsStringAsync();
                return JsonConvert.DeserializeObject<ProductServiceModel>(content);
            }
            return new ProductServiceModel();
        }
        public async Task Create(ProductServiceModel obj)
        {
            string data = URL;
        ...
        public async Task Update(ProductServiceModel obj)
        {
